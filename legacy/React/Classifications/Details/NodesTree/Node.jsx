...
import { selectAddingNodeToClassificationIsSuccess } from '../../../../Reducers/classifications/selectors';
...
const Node = ({
  ...
  const getDeleteModalTitle = (nodeValue) => {
    const title = resources.ContentManagementClassif.DeleteClassifNodeTitleV2;
    const nodeName = <ModalDeleteNodeName>{nodeValue?.Name}</ModalDeleteNodeName>;
