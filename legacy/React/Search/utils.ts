...
export const createSearchResources = (resources: any, type: 'objects' | 'files') => ({
  ...OCResources,
  ContentManager: {
    ...OCResources.ContentManager,
    FilesCount: resources?.ContentManager?.FilesCount,
  },
  Search: {
    ...OCResources.Search,
  ...
  SearchResults: {
    ...
    Title: resources?.SearchResults?.Title,
    Description: resources?.SearchResults?.Description,
  },
  FilesDownloader: {
    Document: resources?.MediaType?.Document,
    Model3D: resources?.MediaType?.Model3D,
    Model2D: resources?.MediaType?.Model2D,
    Images: resources?.MediaType?.Images,
  ...
  Inspector: {
    ...
    CreatedAtValue: resources?.ContentSearchInspect?.CreatedAtValue,
    UpdatedAtValue: resources?.ContentSearchInspect?.UpdatedAtValue,
    ...
    ClassificationsTitle: resources?.SearchResults?.ClassificationFilterTitle,
    SpacesTitle: resources?.ContentManager?.SpacesLabel,
    ...
    SearchVariant: resources?.BimObjectDetails?.SearchVariant,
    SearchProperty: resources?.BimObjectDetails?.SearchProperty,
    RelativeToObject: resources?.ContentSearchInspect?.ObjectLinkLabel,
    ImportData: resources?.ContentSearchInspect?.ImportData,
  },
  Libraries: {
  ...
  Objects: {
    ...
    DownloadButton: resources?.ContentSearch?.Download,
  },
  Preview: {
    ...
    RelatedFiles: resources?.Preview?.RelatedFiles,
  },
  ...
  TagsList: {
    SearchTagsPlaceholder: resources?.TagsList?.SearchTagsPlaceholder
  },
});
