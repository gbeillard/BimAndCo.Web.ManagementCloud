...
type Option = { value: LanguageCode; label: string; icon: IIcon; active: boolean };
...
const getOptions = (
  ...
  languages
    ...
    .map((language) => ({
      ...
      active: language.LanguageCode === selectedLanguage,
    }));
...
const LanguagesMenu: React.FC<Props> = ({
  ...
  return (
    <Menu
      ...
      items={getOptions(languages, languageCode, value)}
