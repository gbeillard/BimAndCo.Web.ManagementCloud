      ...
      .then((configuration) => {
        if (configuration != null) {
          if (configuration.Id > 0) {
            ...
            self.props.HandleClickSaveName(
              self.state.Id,
              self.state.Name,
              self.state.IsPluginDefault
            );
          } else {
  ...
  render() {
    ...
    const languagesList = _.map(this.props.Languages, (lang, i) => {
      ...
      return (
        ...
        >
          <ListItemText inset primary={language_trad} />
        </MenuItem>
      );
    });
            ...
            <div className="modal-body">
              <div id="edit-name-container">
                ...
                <div id="toggle">
                  ...
                  />
                  <p>
                    {this.props.Resources.ContentManagementDictionary.IsPluginDefaultExplanation}
                  </p>
                </div>
                      ...
                      <div
                        {...getRootProps({
                          className: `dropzone-upload-file dropzone-area${
                            this.state.UpdateCompleted ? ' disabled' : ''
                          }`,
                        })}
                      >
                        <input {...getInputProps()} />
                  ...
                  (this.state.LanguageList != null && this.state.LanguageList.length == 0) ? (
                    ...
                    >
                      {`${this.props.Resources.ContentManagementDictionary.DeleteConfiguration} ${
                        languageExist ? `(${this.state.Language})` : ''
                      }`}
                    </Button>
                  ) : null}
                </div>
