      ...
      <div className={classString}>
        ...
        <div className="panel-content">
          <fieldset id="object-type-selection">
            ...
            {this.props.EnableObjectTemplate && (
              <WrapperToggle
                checked={this.props.isTemplate}
                label={this.props.resources.CreateObjectPage.ObjectTemplateToggle}
                onChange={this.props._handleChangeIsTemplate}
              />
            )}
          </fieldset>
...
const WrapperToggle = styled(Toggle)({
