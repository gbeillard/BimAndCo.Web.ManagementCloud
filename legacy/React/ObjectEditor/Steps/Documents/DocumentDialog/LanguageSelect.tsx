...
import { fetchLanguages as fetchLanguagesAction } from '../../../../../Reducers/app/actions';
...
const ButtonControl = React.forwardRef(({ selectProps }: any, ref?: any) => {
  ...
  return (
    <Button ref={ref} onClick={onClickHandler} onBlur={onBlurHandler}>
      <img src={getLogo(value.LanguageCode)} alt="logo" />
    </Button>
  );
}) as ComponentType<ControlProps<any, boolean, GroupBase<any>>>;
    ...
    return (
      <Select
        ...
        getOptionLabel={(language: Language) =>
          getFullLabel(languageCode, language, resources.MetaResource.Multilingual) as string
        }
