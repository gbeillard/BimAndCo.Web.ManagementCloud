...
import { BIMANDCO_ONFLY_ID } from '../../React/Classifications/constants';
...
export const selectDataLanguage = createSelector(selectRoot, (state) => state.DataLanguage);

export const selectManagementCloudId = createSelector(
  selectRoot,
  (state) => state.ManagementCloudId
);
export const selectIsBimAndCoOnfly = createSelector(
  selectRoot,
  (state) => state.ManagementCloudId === BIMANDCO_ONFLY_ID
);
...
export const selectFeatures = createSelector(selectRoot, (state) => state.Features);
...
export const selectSummaryUploadDetailsList = createSelector(
  selectRoot,
  (state) => state.SummaryUploadDetailsList
);
...
export const selectAppConfig = createSelector(
  ...
  selectUserInfo,
  selectFeatures,
  (token, onflyId, resources, language, entityName, dataLanguage, user, featuresFlags) => ({
    apiUrl: API_URL,
    token,
    onflyId,
    resources,
