  ...
  switch (action.type) {
    ...
    case DEPRECATED_FETCH_CLASSIFICATIONS:
      return state
        ...
        .setIn(['api', 'fetchClassifications', 'success'], false)
    ...
    case DEPRECATED_FETCH_CLASSIFICATIONS_SUCCESS:
      return state
        ...
        .setIn(['api', 'fetchClassifications', 'success'], true)
        .setIn(['api', 'fetchClassifications', 'error'], null)
    ...
    case UPDATE_NODE:
      return state
        .setIn(['api', 'updateNode', 'pending'], true)
        .setIn(['api', 'updateNode', 'success'], false)
        .setIn(['api', 'updateNode', 'error'], undefined);
    ...
    case UPDATE_NODE_SUCCESS:
      return state
        ...
        .setIn(['api', 'updateNode', 'pending'], false)
        .setIn(['api', 'updateNode', 'success'], true)
        .setIn(['api', 'updateNode', 'error'], undefined);
    ...
    case UPDATE_NODE_ERROR:
      return state
        .setIn(['api', 'updateNode', 'pending'], false)
        .setIn(['api', 'updateNode', 'success'], false)
        .setIn(['api', 'updateNode', 'error'], action.error);
    ...
    case ADD_NODE_TO_CLASSIFICATION:
      return state
        ...
        .setIn(['api', 'addNodeToClassification', 'success'], false)
        .setIn(['api', 'addNodeToClassification', 'error'], undefined);
    ...
    case ADD_NODE_TO_CLASSIFICATION_SUCCESS:
      return state
        ...
        .setIn(['api', 'addNodeToClassification', 'success'], true)
        .setIn(['api', 'addNodeToClassification', 'error'], undefined);
    ...
    case REMOVE_NODE_FROM_CLASSIFICATION:
      return state
        ...
        .setIn(['api', 'removeNodeFromClassification', 'success'], false)
        .setIn(['api', 'removeNodeFromClassification', 'error'], undefined)
    ...
    case REMOVE_NODE_FROM_CLASSIFICATION_SUCCESS:
      return state
        ...
        .setIn(['api', 'removeNodeFromClassification', 'success'], true)
        .setIn(['api', 'removeNodeFromClassification', 'error'], undefined);
