...
export enum OCAnalyticsEvent {
  SelectedCollections = 'selected_collections',
  ClickedCreateCollectionAndAddContent = 'clicked_create_collection_and_add_content',
  ClickedCreateCollection = 'clicked_create_collection',
}
