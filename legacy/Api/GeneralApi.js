...
export const fetchDocumentTypes = async (token, language) => {
  const response = await fetch(`${API_URL}/api/ws/v1/bimobject/document/types/list`, {
    method: 'GET',
    headers: {
      ...
      Authorization: `Bearer ${
        sessionStorage.getItem('Temporary_token') ||
